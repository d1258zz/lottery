...
namespace D1258zz\Lottery\Listeners;

use Flarum\Foundation\ValidationException;
use Flarum\Post\Event\Saving;
use D1258zz\Lottery\Commands\CreateLottery;
use D1258zz\Lottery\Validators\LotteryOptionValidator;
use D1258zz\Lottery\Validators\LotteryValidator;
    ...
    public function handle(Saving $event)
    {
        ...
        if ($event->actor->cannot('startLottery', $event->post)) {
            ...
            throw new ValidationException([
                'lottery' => $translator->trans('d1258zz-lottery.forum.composer_discussion.no_permission_alert'),
            ]);
        }
